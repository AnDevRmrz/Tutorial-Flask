...
from modelos.modelos import Album, AlbumSchema, db, Usuario, Cancion, CancionSchema, UsuarioSchema
...
class VistaLogIn(Resource):
    def post(self):
        ...
        if usuario:
            registrar_log.delay(u_nombre, datetime.now(datetime.timezone.utc))
